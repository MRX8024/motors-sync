...
#axes_steps_diff: 4
#    Разница микрошагов между двумя осями, чтобы запустить дополнительную
#    проверку актуальной магнитуды у более слабой оси. (только для corexy)
#    Типичное, а так же минимальное значение - max_step_size + 1.
#retry_tolerance: 0
