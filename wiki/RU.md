...
2. Не рекомендуется использовать акселерометр `lis2dw` ввиду малой
   ...
   однако его работа оптимизирована.
...
#    Метод синхронизации двух осей во взаимосвязанной кинематике:
...
#    Метод синхронизации оси/осей в НЕвзаимосвязанной кинематике:
...
5. Синхронизация обычно запускается в начале печати, во время нагрева
...
...
```
6. Так же вводится переменная статуса калибровки, которая сбрасывается при
